...
class Todo(Resource):
    ...
    def put(self, todo_id):
        ...
        TODOS[todo_id] = task, last_updated, due_date, completed, completed_date
        return task, due_date, completed, 201


# For your `put` function, you want to grab the existing todo (using `todo_id`) in your `TODOS` dict, and update the values inside of that object. Look into the update method for python dictionaries.
